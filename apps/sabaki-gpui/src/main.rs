...
use gpui::{
    ...
    Menu, MenuItem, MouseButton, MouseDownEvent, SharedString, StatefulInteractiveElement, Window,
...
use crate::engine_console::{
    EngineLogEntry, GtpEngine, MockGtpEngine, best_analysis_move, best_analysis_winrate,
    entry_for_response, format_console_command, format_gtp_vertex, parse_engine_spec,
    parse_gtp_vertex,
};
...
use crate::goban_view::{render_goban, vertex_at};
use crate::markup::{MarkupTool, create_markup_transaction, render_markup_toolbar};
...
use crate::variation_tree::{build_variation_tree_layout, render_variation_tree};
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .items_center()
                    .gap_3()
                    .child(render_markup_toolbar(self.active_tool, on_tool_clicked))
                    .child(navigation_bar(
                        availability,
                        &position,
                        cx.listener(Self::on_navigate_first),
                        cx.listener(Self::on_navigate_previous),
                        cx.listener(Self::on_navigate_next),
                        cx.listener(Self::on_navigate_last),
                    )),
            )
            .child(
                div()
                    ...
                    .child(format!(
                        "recent: {}",
                        if self.recent_files.list().is_empty() {
                            "none".to_owned()
                        } else {
                            self.recent_files
                                .list()
                    ...
                    .child(format!(
                        "recovery: {}",
                        if self.autosave.info().is_available {
                            "available"
                        } else {
                            "none"
                        }
                    ...
                    .child(format!("benchmark: {}", self.benchmark)),
            )
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .on_mouse_down(
                                MouseButton::Left,
                                cx.listener(Self::on_reload_external),
                            ),
                    )
                    .child(
                        div()
                            ...
                            .on_mouse_down(
                                MouseButton::Left,
                                cx.listener(Self::on_keep_local_external),
                            ),
                    )
            } else {
                div()
            })
            .child(if self.autosave.info().is_available {
                div()
                    .absolute()
                    .left(px(24.0))
                    .top(px(524.0))
                    ...
                    .child(
                        div()
                            ...
                            .on_mouse_down(
                                MouseButton::Left,
                                cx.listener(Self::on_restore_recovery),
                            ),
                    )
                    .child(
                        div()
                            ...
                            .on_mouse_down(
                                MouseButton::Left,
                                cx.listener(Self::on_discard_recovery),
                            ),
                    )
            } else {
                div()
            ...
            .child(
                div()
                    ...
                    .child(if self.installed_plugins.is_empty() {
                        ...
                        div().flex().flex_col().gap_1().text_sm().children(
                    ...
                    .child(format!("panel: {}", self.panel.panel_title))
                    .child(div().flex().flex_col().gap_1().text_sm().children(
                        self.panel.widgets.iter().map(|widget| {
                            div().child(match widget {
                                crate::plugin_contribution::PanelWidget::Label { text } => {
                                    text.clone()
                                }
                    ...
                    .child(div().mt_2().text_sm().child(format!(
                        ...
                        self.theme.board_wood_color().rgb_u32(),
                        self.theme.stone_black_color().rgb_u32(),
                        self.theme.stone_white_color().rgb_u32()
                    ))),
            )
            .child(
                div()
                    ...
                    .child(render_variation_tree(&variation_layout, on_node_clicked)),
            )
            .child(
                div()
                    .absolute()
                    ...
                    .child(
                        div()
                            ...
                            .child(div().flex().flex_col().gap_1().children(
                                self.engine_store.list().iter().map(|record| {
                                    let name = record.name.clone();
                                    let connected = self.engine_session.is_some();
                                    div()
                                        .flex()
                                        .items_center()
                                        .gap_2()
                            ...
                            .child(
                                div()
                                    .track_focus(&self.engine_spec_focus_handle)
                                    .px_2()
                                    .py_1()
                                    .border_1()
                                    .border_color(rgb(0x8a6d3b))
                                    ...
                                    .bg(rgb(0xffffff))
                                    .text_color(rgb(0x222222))
                                    .child(if self.engine_spec_draft.is_empty() {
                                        "Name | path | args | commands".to_owned()
                                    } else {
                                        self.engine_spec_draft.to_string()
                                    })
                                    .on_mouse_down(
                                        MouseButton::Left,
                                        cx.listener(Self::on_engine_spec_focus),
                                    )
                                    .on_key_down(cx.listener(Self::on_engine_spec_key_down)),
                            )
                            .child(
                                div()
                                    .flex()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .on_mouse_down(
                                                MouseButton::Left,
                                                cx.listener(Self::on_analyze),
                                            ),
                                    )
                                    .child(if self.engine_session.is_some() {
                                        div()
                                            .flex()
                                            .gap_2()
                                            .child(
                                                div()
                                                    ...
                                                    .on_mouse_down(
                                                        MouseButton::Left,
                                                        cx.listener(Self::on_engine_move),
                                                    ),
                                            )
                                            .child(
                                                div()
                                                    ...
                                                    .on_mouse_down(
                                                        MouseButton::Left,
                                                        cx.listener(Self::on_engine_disconnect),
                                                    ),
                                            )
                                    } else {
                                        div()
                    ...
                    .child(if self.analysis.is_empty() {
                        div()
                    } else {
                        div()
                            .flex()
                            ...
                            .child("analysis")
                            .child(div().flex().flex_col().gap_1().children(
                                self.analysis.iter().take(3).map(|entry| {
                                        ...
                                        div()
                                            ...
                                            .child(
                                                div()
                                                    .h_full()
                                                    .w(px(140.0
                                                        * best_analysis_winrate(&self.analysis)
                                                            as f32))
                                                    .bg(rgb(0x222222)),
                                            ),
                                    )
                    ...
                    .child(
                        div()
                            ...
                            .text_sm()
                            .child(div().flex().flex_col().gap_1().children(
                                self.engine_log.iter().rev().take(8).map(|entry| {
                            ...
                            .child(
                                div()
                                    .track_focus(&self.engine_input_focus_handle)
                                    .px_2()
                                    .py_1()
                                    .border_1()
                                    .border_color(rgb(0x8a6d3b))
                                    ...
                                    .bg(rgb(0xffffff))
                                    .text_color(rgb(0x222222))
                                    .child(self.engine_draft.clone().to_string())
                                    .on_mouse_down(
                                        MouseButton::Left,
                                        cx.listener(Self::on_engine_input_focus),
                                    )
                                    .on_key_down(cx.listener(Self::on_engine_key_down)),
                            ),
                    ),
            )
            .child(
                div()
                    ...
                    .child(format!(
                        "node inspector · {} · {}",
                        inspector_metadata.title, inspector_metadata.node_id
                    ))
                    .child(
                        div()
                            .flex()
                            ...
                            .child(
                                div()
                                    .track_focus(&self.comment_focus_handle)
                                    .px_2()
                                    .py_1()
                                    .border_1()
                                    .border_color(rgb(0x8a6d3b))
                                    ...
                                    .bg(rgb(0xffffff))
                                    .text_color(rgb(0x222222))
                                    .child(if self.comment_draft.is_empty() {
                                        inspector_metadata.comment.clone()
                                    } else {
                                        self.comment_draft.clone().to_string()
                                    })
                                    .on_mouse_down(
                                        MouseButton::Left,
                                        cx.listener(Self::on_comment_focus),
                                    )
                                    .on_key_down(cx.listener(Self::on_comment_key_down)),
                            ),
                    )
                    .child(
                        div()
                            ...
                            .gap_1()
                            .text_sm()
                            .children(inspector_metadata.properties.iter().map(|row| {
                                div()
                                    .flex()
                                    .gap_2()
                            ...
                            .child(if inspector_metadata.properties.is_empty() {
                                div().text_color(rgb(0x999999)).child("no other properties")
                            } else {
                                div()
                            }),
                    )
                    .child(if inspector_metadata.can_edit_variation {
                        div()
                            .flex()
                            .gap_2()
                            .child(
                                div()
                                    ...
                                    .on_mouse_down(
                                        MouseButton::Left,
                                        cx.listener(Self::on_variation_promote),
                                    ),
                            )
                            .child(
                                div()
                                    ...
                                    .on_mouse_down(
                                        MouseButton::Left,
                                        cx.listener(Self::on_variation_remove),
                                    ),
                            )
                    } else {
                        div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .text_sm()
                            .child("theme")
                            .child(div().flex().gap_1().children(THEME_CHOICES.iter().map(
                                |choice| {
                                    let is_active = *choice == self.theme_choice;
                                    div()
                                            .px_2()
                                            .py_1()
                                            .border_1()
                    ...
                    .child(
                        div()
                            ...
                            .text_sm()
                            .child("board size")
                            .child(div().flex().gap_1().children(BOARD_SIZE_OPTIONS.iter().map(
                                |size| {
                                    let is_active = *size == self.board_size;
                                    div()
                                            .px_2()
                                            .py_1()
                                            .border_1()
                            ...
                            .child(
                                div()
                                    ...
                                    .children(settings_rows.iter().map(|row| {
                                        let is_editing = self.settings_editing_key.as_deref()
                                            == Some(row.key.as_str());
                                        render_setting_row(
                                            row,
                                            is_editing,
                                            &self.settings_draft,
                                            &self.settings_input_focus_handle,
                                            cx,
                                        )
                                    })),
                            ),
            ...
            .child(
                div()
                    ...
                    .child(render_goban(&snapshot.board, BOARD_PIXEL_SIZE, &self.theme))
                    .on_mouse_down(MouseButton::Left, cx.listener(Self::on_board_clicked)),
            )
            .child(if let Some(vertex) = self.analysis_best_move {
                let (x, y) = goban_view::intersection_position(
                    &snapshot.board,
                    BOARD_PIXEL_SIZE,
                    vertex.column,
                    vertex.row,
