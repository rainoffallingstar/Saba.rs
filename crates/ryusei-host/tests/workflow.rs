use ryusei_domain_core::{Color, GameSnapshot, GameTransaction, Vertex};
use ryusei_host::{
...
impl GameFileAccess for MemoryFileAccess {
    fn read_game_file(
        ...
        self.files
            ...
            .ok_or_else(|| ryusei_host::HostError::FileRead("the file does not exist".to_owned()))
    }
...
fn play_move_transaction() -> GameTransaction {
    GameTransaction {
        ...
        transaction_type: ryusei_domain_core::GameTransactionType::PlayMove,
