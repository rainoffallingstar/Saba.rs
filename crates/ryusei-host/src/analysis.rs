...
impl AnalysisCommandSink for ryusei_domain_core::gtp::AnalysisStream {
    fn send_command(&mut self, command: &str) -> std::io::Result<()> {
        ryusei_domain_core::gtp::AnalysisStream::send_command(self, command)
    }
}
