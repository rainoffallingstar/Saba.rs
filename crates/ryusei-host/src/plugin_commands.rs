...
impl BuiltinPluginCommandRegistry {
    pub fn resolve(plugin_id: &str, command_id: &str) -> Option<BuiltinPluginCommand> {
        match (plugin_id, command_id) {
            ...
            ("org.ryusei.katago-setup-hub", "org.ryusei.katago-setup-hub.download_lightweight") => {
                Some(BuiltinPluginCommand::KataGoDownload(
                    KataGoModelTier::Lightweight,
                ))
            }
            ("org.ryusei.katago-setup-hub", "org.ryusei.katago-setup-hub.download_strongest") => {
                Some(BuiltinPluginCommand::KataGoDownload(
                    KataGoModelTier::Strongest,
                ))
            }
            ("org.ryusei.fox-kifu-sync", "org.ryusei.fox-kifu-sync.fetch_latest")
            | ("org.ryusei.fox-kifu-sync", "org.ryusei.fox-kifu-sync.query_user") => {
                Some(BuiltinPluginCommand::FoxFetchLatest)
            }
            ("org.ryusei.position-checker", "org.ryusei.position-checker.check") => {
                Some(BuiltinPluginCommand::PositionCheck)
            }
            ("org.ryusei.sgf-exporter", "org.ryusei.sgf-exporter.export") => {
...
mod tests {
    ...
    fn registry_resolves_every_builtin_command() {
        ...
        assert_eq!(
            BuiltinPluginCommandRegistry::resolve(
                "org.ryusei.katago-setup-hub",
                "org.ryusei.katago-setup-hub.download_balanced"
            ),
            Some(BuiltinPluginCommand::KataGoDownload(
                KataGoModelTier::Balanced
            ))
        ...
        assert_eq!(
            BuiltinPluginCommandRegistry::resolve(
                "org.ryusei.katago-setup-hub",
                "org.ryusei.katago-setup-hub.download_lightweight"
            ),
            Some(BuiltinPluginCommand::KataGoDownload(
                KataGoModelTier::Lightweight
            ))
        ...
        assert_eq!(
            BuiltinPluginCommandRegistry::resolve(
                "org.ryusei.katago-setup-hub",
                "org.ryusei.katago-setup-hub.download_strongest"
            ),
            Some(BuiltinPluginCommand::KataGoDownload(
                KataGoModelTier::Strongest
            ))
        ...
        assert_eq!(
            BuiltinPluginCommandRegistry::resolve(
                ...
                "org.ryusei.fox-kifu-sync.query_user"
            ),
            Some(BuiltinPluginCommand::FoxFetchLatest)
        );
        assert_eq!(
            BuiltinPluginCommandRegistry::resolve(
                "org.ryusei.position-checker",
                "org.ryusei.position-checker.check"
            ),
            Some(BuiltinPluginCommand::PositionCheck)
        );
        assert_eq!(
            BuiltinPluginCommandRegistry::resolve(
                "org.ryusei.sgf-exporter",
