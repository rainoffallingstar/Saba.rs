...
pub enum WasmWorkflowError {
    ...
    #[error(transparent)]
    Runtime(#[from] ryusei_plugin_runtime::WasmError),
    #[error(transparent)]
...
) -> ryusei_plugin_runtime::WasmCapabilities {
...
mod tests {
    use super::*;
    use ryusei_plugin_runtime::{PluginManifest, PluginPermission};
...
"#;
    ...
    fn capabilities_follow_granted_permissions() {
        use ryusei_plugin_runtime::WasmCapabilities;
