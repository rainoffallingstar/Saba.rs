...
use sabaki_plugin_runtime::{PluginPermission, PluginRecord, PluginRuntime};
...
mod tests {
    ...
    use sabaki_plugin_runtime::{PluginManifest, PluginPermission, PluginRecord, PluginRuntime};
